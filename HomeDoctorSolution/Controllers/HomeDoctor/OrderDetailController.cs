    ...
    namespace HomeDoctorSolution.Controllers
    {
        ...
        public class OrderDetailController : BaseController
        {
            ...
            public OrderDetailController(IOrderDetailService _service, ICacheHelper cacheHelper )  : base(cacheHelper)
            {
                service = _service;
            }
            [HttpGet]
            ...
            [HttpPost]
            [Route("api/Delete")]
            public async Task<IActionResult> Delete([FromBody]OrderDetail model)
            {
                if (ModelState.IsValid)
                {
                    try
            ...
            public async Task<IActionResult> DeletePermanently([FromBody]OrderDetail model)
            {
                var result = 0;
                if (!(model.Id > 0))
                {
            ...
            public async Task<IActionResult> ListServerSide([FromBody] OrderDetailDTParameters parameters)
            {
                try
                {
