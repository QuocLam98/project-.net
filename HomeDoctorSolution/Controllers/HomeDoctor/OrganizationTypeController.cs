    ...
    namespace HomeDoctorSolution.Controllers
    {
        ...
        public class OrganizationTypeController : BaseController
        {
            ...
            public OrganizationTypeController(IOrganizationTypeService _service, ICacheHelper cacheHelper )  : base(cacheHelper)
            {
                service = _service;
            }
            [HttpGet]
            ...
            [HttpPost]
            [Route("api/Add")]
            public async Task<IActionResult> Add([FromBody]OrganizationType model)
            {
            ...
            [HttpPost]
            [Route("api/Update")]
            public async Task<IActionResult> Update([FromBody]OrganizationType model)
            {
                if (ModelState.IsValid)
                {
                    try
            ...
            [HttpPost]
            [Route("api/Delete")]
            public async Task<IActionResult> Delete([FromBody]OrganizationType model)
            {
                if (ModelState.IsValid)
                {
                    try
            ...
            public async Task<IActionResult> DeletePermanently([FromBody]OrganizationType model)
            {
                var result = 0;
                if (!(model.Id > 0))
                {
            ...
            [HttpGet]
            [Route("api/Count")]
            public int CountOrganizationType()
            {
            ...
            public async Task<IActionResult> ListServerSide([FromBody] OrganizationTypeDTParameters parameters)
            {
                try
                {
