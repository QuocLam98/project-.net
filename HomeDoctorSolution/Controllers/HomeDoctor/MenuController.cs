    ...
    namespace HomeDoctorSolution.Controllers
    {
        ...
        public class MenuController : BaseController
        {
            ...
            public MenuController(IMenuService _service, ICacheHelper cacheHelper )  : base(cacheHelper)
            {
                service = _service;
            }
            [HttpGet]
            ...
            public async Task<IActionResult> ListServerSide([FromBody] MenuDTParameters parameters)
            {
                try
                {
