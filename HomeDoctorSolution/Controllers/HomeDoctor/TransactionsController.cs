    ...
    namespace HomeDoctorSolution.Controllers
    {
        ...
        public class TransactionsController : BaseController
        {
            ...
            public TransactionsController(ITransactionsService _service, ICacheHelper cacheHelper )  : base(cacheHelper)
            {
                service = _service;
            }
            [HttpGet]
            ...
            public async Task<IActionResult> DeletePermanently([FromBody]Transaction model)
            {
                var result = 0;
                if (!(model.Id > 0))
                {
            ...
            public async Task<IActionResult> ListServerSide([FromBody] TransactionsDTParameters parameters)
            {
                try
                {
