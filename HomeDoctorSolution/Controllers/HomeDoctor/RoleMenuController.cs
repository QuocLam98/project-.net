...
namespace HomeDoctorSolution.Controllers
{
    ...
    public class RoleMenuController : BaseController
    {
        ...
        public RoleMenuController(IRoleMenuService _service, ICacheHelper cacheHelper) : base(cacheHelper)
        {
            service = _service;
        }
        [HttpGet]
        ...
        [HttpPost]
        [Route("api/Add")]
        public async Task<IActionResult> Add([FromBody] RoleMenu model)
        {
        ...
        [HttpPost]
        [Route("api/Update")]
        public async Task<IActionResult> Update([FromBody] RoleMenu model)
        {
            if (ModelState.IsValid)
            {
                try
        ...
        [HttpPost]
        [Route("api/Delete")]
        public async Task<IActionResult> Delete([FromBody] RoleMenu model)
        {
            if (ModelState.IsValid)
            {
                try
        ...
        public async Task<IActionResult> DeletePermanently([FromBody] RoleMenu model)
        {
            var result = 0;
            if (!(model.Id > 0))
            {
        ...
        public async Task<IActionResult> ListServerSide([FromBody] RoleMenuDTParameters parameters)
        {
            try
            {
        ...
        [HttpPost]
        [Route("api/Add-many")]
        public async Task<IActionResult> AddMany([FromBody] RoleMenuDTO model)
        {
            if (ModelState.IsValid)
            {
                //1. business logic
