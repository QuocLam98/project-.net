    ...
    namespace HomeDoctorSolution.Controllers
    {
        ...
        public class SystemConfigController : BaseController
        {
            ...
            public SystemConfigController(ISystemConfigService _service, ICacheHelper cacheHelper )  : base(cacheHelper)
            {
                service = _service;
            }
            [HttpGet]
            ...
            public async Task<IActionResult> ListServerSide([FromBody] SystemConfigDTParameters parameters)
            {
                try
                {
