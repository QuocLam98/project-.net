    ...
    namespace HomeDoctorSolution.Controllers
    {
        ...
        public class CommentController : BaseController
        {
            ...
            public CommentController(ICommentService _service, ICacheHelper cacheHelper )  : base(cacheHelper)
            {
                service = _service;
            }
            [HttpGet]
            ...
            public async Task<IActionResult> ListServerSide([FromBody] CommentDTParameters parameters)
            {
                try
                {
