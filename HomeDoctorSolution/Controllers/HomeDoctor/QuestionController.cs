    ...
    namespace HomeDoctorSolution.Controllers
    {
        ...
        public class QuestionController : BaseController
        {
            ...
            public QuestionController(IQuestionService _service, ICacheHelper cacheHelper )  : base(cacheHelper)
            {
                service = _service;
            }
            [HttpGet]
            ...
            public async Task<IActionResult> ListServerSide([FromBody] QuestionDTParameters parameters)
            {
                try
                {
