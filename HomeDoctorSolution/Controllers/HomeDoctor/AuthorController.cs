    ...
    namespace HomeDoctorSolution.Controllers
    {
        ...
        public class AuthorController : BaseController
        {
            ...
            public AuthorController(IAuthorService _service, ICacheHelper cacheHelper )  : base(cacheHelper)
            {
                service = _service;
            }
            [HttpGet]
            ...
            [HttpPost]
            [Route("api/Delete")]
            public async Task<IActionResult> Delete([FromBody]Author model)
            {
                if (ModelState.IsValid)
                {
                    try
            ...
            public async Task<IActionResult> DeletePermanently([FromBody]Author model)
            {
                var result = 0;
                if (!(model.Id > 0))
                {
