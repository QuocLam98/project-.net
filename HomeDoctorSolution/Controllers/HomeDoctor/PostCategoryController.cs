    ...
    namespace HomeDoctorSolution.Controllers
    {
        ...
        public class PostCategoryController : BaseController
        {
            ...
            public PostCategoryController(IPostCategoryService _service, ICacheHelper cacheHelper )  : base(cacheHelper)
            {
                service = _service;
            }
            [HttpGet]
            ...
            public async Task<IActionResult> ListServerSide([FromBody] PostCategoryDTParameters parameters)
            {
                try
                {
