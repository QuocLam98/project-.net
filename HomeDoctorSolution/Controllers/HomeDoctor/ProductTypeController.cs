...
namespace HomeDoctorSolution.Controllers
{
    ...
    public class ProductTypeController : BaseController
    {
        ...
        public ProductTypeController(IProductTypeService _service, ICacheHelper cacheHelper) : base(cacheHelper)
        {
            service = _service;
        }
        [HttpGet]
        ...
        public async Task<IActionResult> ListServerSide([FromBody] ProductTypeDTParameters parameters)
        {
            try
            {
