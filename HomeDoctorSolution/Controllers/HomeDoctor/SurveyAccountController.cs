    ...
    namespace HomeDoctorSolution.Controllers
    {
        ...
        {
            ISurveyAccountService service;
            public SurveyAccountController(ISurveyAccountService _service, ICacheHelper cacheHelper )  : base(cacheHelper)
            {
                service = _service;
            }
            [HttpGet]
            ...
            public async Task<IActionResult> ListServerSide([FromBody] SurveyAccountDTParameters parameters)
            {
                try
                {
