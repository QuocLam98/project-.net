    ...
    namespace HomeDoctorSolution.Controllers
    {
        ...
        public class VoucherController : BaseController
        {
            ...
            public VoucherController(IVoucherService _service, ICacheHelper cacheHelper )  : base(cacheHelper)
            {
                service = _service;
            }
            [HttpGet]
            ...
            public async Task<IActionResult> ListServerSide([FromBody] VoucherDTParameters parameters)
            {
                try
                {
