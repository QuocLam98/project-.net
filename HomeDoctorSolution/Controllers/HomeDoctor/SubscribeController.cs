    ...
    namespace HomeDoctorSolution.Controllers
    {
        ...
        public class SubscribeController : BaseController
        {
            ...
            public SubscribeController(ISubscribeService _service, ICacheHelper cacheHelper )  : base(cacheHelper)
            {
                service = _service;
            }
            [HttpGet]
            ...
            public async Task<IActionResult> ListServerSide([FromBody] SubscribeDTParameters parameters)
            {
                try
                {
