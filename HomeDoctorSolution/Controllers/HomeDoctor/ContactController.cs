    ...
    namespace HomeDoctorSolution.Controllers
    {
        ...
        public class ContactController : BaseController
        {
            ...
            public ContactController(IContactService _service, ICacheHelper cacheHelper )  : base(cacheHelper)
            {
                service = _service;
            }
            [HttpGet]
            ...
            public async Task<IActionResult> DeletePermanently([FromBody]Contact model)
            {
                var result = 0;
                if (!(model.Id > 0))
                {
            ...
            public async Task<IActionResult> ListServerSide([FromBody] ContactDTParameters parameters)
            {
                try
                {
