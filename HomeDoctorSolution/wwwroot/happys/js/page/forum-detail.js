...
$(document).ready(function () {
    ...
    LoadDataCategory();
    $.when(LoadDataOfCategory()).done(function () {
        //debugger;
...
async function LoadDataOfCategory() {
            ...
            if (item.lastedPost == null) {
                $("#typical-category").append(`
                            <li>
                                ...
                                <a href="/danh-sach-thu-muc-dien-dan/`+ item.id + `">` + item.name + `</a> <span class="count">` + item.countPost + `</span>
                            </li>
                `
                )
            }
