...
$(document).ready(async function () {
    ...
    LoadPagingPage("booking/api/count-list-booking-by-accountId?bookingStatusId=" + bookingStatusId, element, loadDataByStatus, 6);
    $(document).on("click", ".parent-button-container", async function () {
        ...
        let element = $(".pagination_default");
        LoadPagingPage("booking/api/count-list-booking-by-accountId?bookingStatusId=" + statusId, element, loadDataByStatus, 6);
    });
});
