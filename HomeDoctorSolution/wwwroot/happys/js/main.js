(function ($) {
  ...
  if ($(".doc_testimonial_area").length) {
    $(".doc_testimonial_slider").slick({
      ...
      dots: false,
      arrows: false,
      asNavFor: ".doc_img_slider,.doc_conselor_slider",
    });
     $(".doc_conselor_slider").slick({
      autoplay: true,
      slidesToShow: 1,
      slidesToScroll: 1,
      autoplaySpeed: 5000,
      ...
      dots: true,
      arrows: false,
      asNavFor: ".doc_img_slider,.doc_testimonial_slider",
    });
    $(".doc_img_slider").slick({
      slidesToShow: 1,
      slidesToScroll: 1,
      asNavFor: ".doc_testimonial_slider,.doc_conselor_slider",
      arrows: false,
      fade: true,
      focusOnSelect: true,
    });
