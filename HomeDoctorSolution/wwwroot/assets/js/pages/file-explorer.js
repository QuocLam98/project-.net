...
var FILE_EXPLORER = {
    option: {
        maximum: 26214400,
        folderUploadId: 1000001,
        defaultFolderUploadId: 1000001
    },
    elements: {
        loading: "#",
        upload: "#",
    ...
    ajax: {
        uploadURL: `${systemURL}api/file-explorer/upload-file`,
        uploadLagreFileURL: `${systemURL}api/file-explorer/upload-large-file`,
        fileSourceURL: `${systemURL}api/file-explorer/list-upload-file`,
        folderSourseURL: `${systemURL}api/file-explorer/list-all-folder`,
            ...
            $.when(t.getFolderData()).done(function () {
                $(t.buttons.btnChooseFile).off('click').on('click', function (e) {
                    ...
                    if (tagName == "input") {
                        ...
                        t.imgElement.attr("src", src).trigger("change-avatar");
                    }
                    $(t.elements.parent).modal('hide');
                })
                $(t.buttons.btnDeleteFile).off('click').on('click', function (e) {
                    ...
                    if (tagName == "input") {
                        ...
                        //t.imgElement.attr("src", src).trigger("change");
                    }
                    t.deleteFile(file);
                })
            })
