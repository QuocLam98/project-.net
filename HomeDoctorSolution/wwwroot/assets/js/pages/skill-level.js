...
async function editItem(id) {
    ...
    $("#skillLevelModalTitle").text(id > 0 ? "Cập nhật nghề nghiệp" : "Thêm mới nghề nghiệp");
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        if (response.isSucceeded) {
                            Swal.fire(
                                'Thêm mới kỹ năng',
                                'Loại kỹ năng <b>' + $("#skillLevelName").val() + '</b> đã được thêm mới thành công.',
                                'success'
                            ).then(function () {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        if (response.isSucceeded) {
                            Swal.fire(
                                'Cập nhật kỹ năng',
                                'Loại kỹ năng <b>' + $("#skillLevelName").val() + '</b> đã được cập nhật thành công.',
                                'success'
                            ).then((result) => {
                                $("#skillLevelModal").modal("hide");
                                reGenTable();
