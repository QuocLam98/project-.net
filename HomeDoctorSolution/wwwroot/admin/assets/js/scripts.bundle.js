...
//
var modeDion = localStorage.getItem("mode_side-bar");
if (modeDion == "light-sidebar") {
    $(".form-check-image.form-check-success").removeClass("active");
    $("#kt_app_body").attr("data-kt-app-layout", "light-sidebar");
    $(".form-check-input[value=light-sidebar]").prop("checked", true);
    $($(".form-check-input[value=light-sidebar]")[0].labels).addClass("active");
    $("#kt_app_sidebar_logo .app-sidebar-logo-default").attr("src", "/homedoctor/img/header/header-logo.png");
    if (themeMode == "dark") {
        $("#loadingLogo").attr("src", "/admin/assets/media/logos/dion-logo.png");
    }
    else {
        $("#loadingLogo").attr("src", "/homedoctor/img/header/header-logo.png");
    }

}
else {
    $(".form-check-image.form-check-success").removeClass("active");
    $("#kt_app_body").attr("data-kt-app-layout", "dark-sidebar");
    $(".form-check-input[value=dark-sidebar]").prop("checked", true);
    $($(".form-check-input[value=dark-sidebar]")[0].labels).addClass("active");
    $("#kt_app_sidebar_logo .app-sidebar-logo-default").attr("src", "/admin/assets/media/logos/dion-logo.png");
    if (themeMode == "dark") {
        $("#loadingLogo").attr("src", "/admin/assets/media/logos/dion-logo.png");
    }
    else {
...
var KTAppLayoutBuilder = function() {
	...
	var handlePreview = function() {
		previewButton.addEventListener("click", function(e) {
            ...
            var mode = url.get("layout-builder[layout][app][general][layout]");
            setTimeout(function () {
                if (mode == "light-sidebar") {
                    $("#kt_app_body").attr("data-kt-app-layout", "light-sidebar");
                    $("#kt_app_sidebar_logo .app-sidebar-logo-default").attr("src", "/homedoctor/img/header/header-logo.png");
                }
                else {
                ...
                localStorage.setItem("mode_side-bar", mode);
                previewButton.removeAttribute("data-kt-indicator");
            }, 1000);
            setTimeout(function () {
                toastr.success(
                    "Bạn đã cài đặt màn hình thành công",
                    "Thành công!",
	...
	var handleReset = function() {
		resetButton.addEventListener("click", function(e) {
            ...
            // Prepare form data
            setTimeout(function () {
                localStorage.setItem("mode_side-bar", "light-sidebar");
                $("#kt_app_body").attr("data-kt-app-layout", "light-sidebar");
                $("#kt_app_sidebar_logo .app-sidebar-logo-default").attr("src", "/homedoctor/img/header/header-logo.png");
                $(".form-check-image.form-check-success").removeClass("active");
                $("#kt_app_body").attr("data-kt-app-layout", "light-sidebar");
